...
export const featuredProjects: LocalProject[] = [
  ...
  },
  {
    ...
    category: "system",
    description:
      "A university hostel management system for room inventory, student registration, room allocation, billing, invoices, payments, maintenance requests, visitor management, reports and role-based administration. The live portfolio link opens a dedicated interactive preview.",
...
export const repoLiveUrlByName: Record<string, string> = {
  ...
  "university-hostel-management-system": "https://university-hostel-management-demo.vercel.app/",
